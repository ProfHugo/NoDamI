...
public class NodamiConfig {
	...
	private static void syncConfig() {
		...
		attackExcludedEntities = config.getStringList("attackExcludedEntities", "Exclusions", new String[] {"minecraft:slime"}, "List of entities that need to give iFrames on attacking");
